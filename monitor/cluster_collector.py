...
SSH_USER = 'root'
SSH_PASS = 'Openthekey@2026'
SSH_PORT = 22

NAMENODE_API = 'http://10.151.83.131:9870'
YARN_API     = 'http://10.151.83.131:8088'

DB_CONFIG = {
    'host':     'localhost',
    'port':     3306,
    'user':     'root',
    'password': 'Openthekey@2025',
    'database': 'bd_monitor',
    'charset':  'utf8mb4',
}
...
def ensure_tables(cursor):
    tables = [
        ...
        'm_mem_free', 'm_mem_total', 'm_mem_buffers', 'm_mem_cached', 'm_mem_shared', 'm_swap_free',
        # datanode
...
DATANODE_PORTS = {
    'hdfs2': 'http://10.151.83.132:9864',
    'hdfs3': 'http://10.151.83.133:9864',
}
